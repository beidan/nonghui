...
;(function(window, undefined) {
   ...
   * @param {Mixed} [thisArg] The `this` binding of `callback`.
   * @param- {Array} [stackA=[]] Internally used to track traversed src objects.
   * @param- {Array} [stackB=[]] Internally used to associate clones with src counterparts.
  ...
  function clone(value, deep, callback, thisArg, stackA, stackB) {
    ...
    // add the src value to the stack of traversed objects
  ...
  /**
   * Assigns own enumerable properties of src object(s) to the destination
   ...
   * @category Objects
   * @param {Object} object The destination object.
   * @param {Object} [source1, source2, ...] The src objects.
  ...
  /**
   * Recursively merges own enumerable properties of the src object(s), that
   * don't resolve to `undefined`, into the destination object. Subsequent sources
   * will overwrite propery assignments of previous sources. If a `callback` function
   * is passed, it will be executed to produce the merged values of the destination
   * and src properties. If `callback` returns `undefined`, merging will be
   ...
   *  and `stackB` are arrays of traversed objects instead of src objects.
   * @param- {Array} [stackA=[]] Internally used to track traversed src objects.
      ...
      (isArray(args[index]) ? forEach : forOwn)(args[index], function(source, key) {
        ...
        if (source && ((isArr = isArray(source)) || isPlainObject(source))) {
          ...
          if (!found) {
            ...
            // add `src` and associated `value` to the stack of traversed objects
            stackA.push(source);
            stackB.push(value);
   ...
   *  sourceURL - The sourceURL of the template's compiled src.
   ...
   * }
   *
   * // using the `src` property to inline compiled templates for meaningful
  ...
  function template(text, data, options) {
    ...
    var sourceURL = '\n/*\n//@ sourceURL=' + (options.sourceURL || '/lodash/template/src[' + (templateCounter++) + ']') + '\n*/';
    ...
    // provide the compiled function's src via its `toString` method, in
    // supported environments, or the `src` property as a convenience for
